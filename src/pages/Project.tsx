...
export const projectItems: ImageItem[] = [
  {
    id: "gathering-stage",
    src: "/YUE-homesite/images/catelo cover.jpg",
    ...
    detailedImages: [
      { caption: "Overview", url: "/YUE-homesite/images/main-2.jpeg" },
      { caption: "Entrance", url: "/YUE-homesite/images/entrance2.jpeg" },
      { caption: "Ramp and Platform", url: "/YUE-homesite/images/longitutinal.jpeg" },
      { caption: "Diagram", url: "/YUE-homesite/images/catelo diagram.jpg" },
      { caption: "Masterplan", url: "/YUE-homesite/images/masterplan--01.png" },
      { caption: "Activities", url: "/YUE-homesite/images/catelo diagram2.jpg" },
      { caption: "Piazza", url: "/YUE-homesite/images/square1.png" }
    ],
    projectInfo: {
  ...
  {
    id: "pilgrims-heaven",
    src: "/YUE-homesite/images/church cover.jpg",
    ...
    detailedImages: [
      { caption: "Overview", url: "/YUE-homesite/images/church render.jpeg" },
      { caption: "Entrance", url: "/YUE-homesite/images/rendering.png" },
      { caption: "Diagram", url: "/YUE-homesite/images/isometric2-01.png" },
      { caption: "Plan", url: "/YUE-homesite/images/plans.jpg" },
      { caption: "Detail of New Construction and Terrace", url: "/YUE-homesite/images/detial.png" }
    ],
    projectInfo: {
  ...
  {
    id: "live-with-water",
    src: "/YUE-homesite/images/mo cover.jpg",
    ...
    detailedImages: [
      { caption: "Topography of Maputo", url: "/YUE-homesite/images/maputo site.jpg" },
      { caption: "Urban drainage system", url: "/YUE-homesite/images/maputo diagram.jpg" },
      { caption: "Flooding and Social Problems", url: "/YUE-homesite/images/maputo map1.jpg" },
      { caption: "General Scheme", url: "/YUE-homesite/images/maputo Water circulation.jpg" },
      { caption: "Public Space", url: "/YUE-homesite/images/maputo_Public space.jpg" },
      { caption: "Rainy Season and Dry Season", url: "/YUE-homesite/images/maputo section.jpg" }
    ],
    projectInfo: {
      type: "Urban Design",
      time: "2021",
  ...
  {
    id: "secret-garden",
    src: "/YUE-homesite/images/sg cover.jpg",
    title: "SECRET GARDEN",
    ...
    detailedImages: [
      { caption: "Concept", url: "/YUE-homesite/images/Sg-concept.png" },
      { caption: "Overview", url: "/YUE-homesite/images/Sg-overview.jpeg" },
      { caption: "Map", url: "/YUE-homesite/images/Sg-map.jpeg" },
      { caption: "Scheme", url: "/YUE-homesite/images/Sg_map scheme.png" },
      { caption: "Architecture", url: "/YUE-homesite/images/Sg-Reno scheme.jpeg" },
      { caption: "Section", url: "/YUE-homesite/images/Sg-plan section.jpeg" },
      { caption: "Experience", url: "/YUE-homesite/images/Sg-render2.png" },
      { caption: "Experience", url: "/YUE-homesite/images/Sg-render1.png" }
    ],
    projectInfo: {
      type: "Renovation",
      time: "2019",
  ...
  {
    id: "natural-museum",
    src: "/YUE-homesite/images/museo cover.jpg",
    ...
    detailedImages: [
      { caption: "Overview", url: "/YUE-homesite/images/museum_overview.jpg" },
      { caption: "Entrance", url: "/YUE-homesite/images/museum-Entrance View.jpeg" },
      { caption: "Gallery", url: "/YUE-homesite/images/museum-Gallery Inward.jpeg" },
      { caption: "Gallery", url: "/YUE-homesite/images/museum-Gallery outward.jpeg" },
      { caption: "Skiing Context", url: "/YUE-homesite/images/museum-Ski Resort.jpeg" },
      { caption: "Form", url: "/YUE-homesite/images/museum-Form and Context.jpeg" },
      { caption: "Plan B1", url: "/YUE-homesite/images/museum-Plan B1.jpeg" },
      { caption: "Plan Groundfloor", url: "/YUE-homesite/images/museum-Plan GroundFloor.jpeg" }
    ],
    projectInfo: {
